...
```bash
git clone https://github.com/WoodpeckerLaud/sample-well-architected-skills-and-steering-854.git
cd sample-well-architected-skills-and-steering-854
python setup.py
```
...
<!-- Last updated: 2026-06-06 15:51:21 -->
